...
def plot_mortality_violin(df = None, save = False, name = 'img/demographic/mortality.png'):

    # fetch data
    df = _mortality_data() if df is None else df
...
plot_mortality_violin(save = True)
plt.show()
